namespace AdminApp
{
    partial class FormEditCustomer
    {
        ...
        private void InitializeComponent()
        {
            ...
            LbTenKH = new Guna.UI2.WinForms.Guna2HtmlLabel();
            ...
            lbDiaChi = new Guna.UI2.WinForms.Guna2HtmlLabel();
            txtDiaChi = new Guna.UI2.WinForms.Guna2TextBox();
            lbThoiGian = new Guna.UI2.WinForms.Guna2HtmlLabel();
            txtThoiGian = new Guna.UI2.WinForms.Guna2TextBox();
            btnLuu = new Guna.UI2.WinForms.Guna2Button();
            dtpNgaySinh = new Guna.UI2.WinForms.Guna2DateTimePicker();
            CbGioiTinh = new Guna.UI2.WinForms.Guna2ComboBox();
            ...
            guna2ShadowPanel1.Size = new Size(1420, 56);
            ...
            LbThemPhim.Location = new Point(3, 8);
            LbThemPhim.Name = "LbThemPhim";
            LbThemPhim.Size = new Size(428, 39);
            LbThemPhim.TabIndex = 3;
            LbThemPhim.Text = "Chỉnh Sửa Thông Tin Khách Hàng";
            // 
            // LbTenKH
            // 
            ...
            txtTenKH.FocusedState.BorderColor = Color.FromArgb(255, 192, 128);
            txtTenKH.FocusedState.FillColor = Color.White;
            txtTenKH.FocusedState.ForeColor = Color.Black;
            txtTenKH.FocusedState.PlaceholderForeColor = Color.Transparent;
            ...
            txtSDT.FocusedState.BorderColor = Color.FromArgb(255, 192, 128);
            txtSDT.FocusedState.FillColor = Color.White;
            txtSDT.FocusedState.ForeColor = Color.Black;
            txtSDT.FocusedState.PlaceholderForeColor = Color.Transparent;
            ...
            txtEmail.FocusedState.BorderColor = Color.FromArgb(255, 192, 128);
            txtEmail.FocusedState.FillColor = Color.White;
            txtEmail.FocusedState.ForeColor = Color.Black;
            txtEmail.FocusedState.PlaceholderForeColor = Color.Transparent;
            ...
            txtDiaChi.FocusedState.BorderColor = Color.FromArgb(255, 192, 128);
            txtDiaChi.FocusedState.FillColor = Color.White;
            txtDiaChi.FocusedState.ForeColor = Color.Black;
            txtDiaChi.FocusedState.PlaceholderForeColor = Color.Transparent;
            ...
            txtThoiGian.DisabledState.FillColor = Color.FromArgb(226, 226, 226);
            txtThoiGian.DisabledState.ForeColor = Color.FromArgb(138, 138, 138);
            txtThoiGian.DisabledState.PlaceholderForeColor = Color.FromArgb(138, 138, 138);
            txtThoiGian.FocusedState.BorderColor = Color.FromArgb(255, 192, 128);
            txtThoiGian.FocusedState.FillColor = Color.White;
            txtThoiGian.FocusedState.ForeColor = Color.Black;
            txtThoiGian.FocusedState.PlaceholderForeColor = Color.Transparent;
            txtThoiGian.Font = new Font("Segoe UI", 9F);
            txtThoiGian.ForeColor = Color.Black;
            ...
            dtpNgaySinh.FillColor = SystemColors.GradientInactiveCaption;
        ...
        private Guna.UI2.WinForms.Guna2HtmlLabel lbThoiGian;
